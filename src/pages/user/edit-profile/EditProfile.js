import {
  ...
  fetchUserData,
  updateUserData,
} from '../../../../server/api/user'; // fetchUserData와 updateUserData 가져오기
import {
  Button,
  EditProfileForm,
  ProfileImage,
  ...
  getCurrentUserId(async userId => {
    if (userId) {
      ...
      if (currUser) {
        ...
        const visibilityIconPassword =
          container.querySelector('#toggle-password');
